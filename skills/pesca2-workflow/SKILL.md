...
1. Confirm that the active Roblox Studio instance is named `Pesca2` before any mutation. The Roblox MCP is configured in Codex and Antigravity for this open instance.
