...
Estas instruções pertencem exclusivamente a este repositório. Antes de investigar, planejar ou alterar qualquer parte do jogo, leia também a skill principal local: [`.codex/skills/pesca2-workflow/SKILL.md`](.codex/skills/pesca2-workflow/SKILL.md).
...
- Para interfaces, leia e siga a skill local [`.codex/skills/pesca2-interface/SKILL.md`](.codex/skills/pesca2-interface/SKILL.md) antes de editar.
- Para cenário, criação ou manipulação de qualquer objeto 3D, leia e siga a skill local [`.codex/skills/pesca2-3d/SKILL.md`](.codex/skills/pesca2-3d/SKILL.md) antes de editar.
- Nunca grave, exponha ou faça commit de chaves de API, tokens ou outras credenciais.

## Localização das skills

Todas as skills do Pesca2 ficam versionadas neste próprio repositório, em `.codex/skills/`. Um `git clone` ou `git pull` traz `AGENTS.md` e as três skills junto; não existe dependência de `~/.codex/skills` nem de qualquer pasta pessoal de outro computador.
